  ...
  return (
    <>
      ...
      <p className="mx-auto mb-4 max-w-[580px] text-center">
        ...
        підібрати запчастини. Якщо VIN-код наразі недоступний, заповніть, будь
        ласка, форму — наші фахівці зв’яжуться з Вами для уточнення необхідної
        інформації та підбору відповідних запчастин.
      </p>
